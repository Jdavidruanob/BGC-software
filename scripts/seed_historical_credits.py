"""
Carga masiva de créditos históricos (datos de años anteriores).
Ejecutar una sola vez en la DB objetivo cuando los créditos no estén cargados.
Uso: python scripts/seed_historical_credits.py [ruta_db]
"""
import sys
import os
...
def run(db_path=None):
    ...
    db.add_multiple_historical_credits(credits_list)
    print("✅ Créditos históricos cargados.")
