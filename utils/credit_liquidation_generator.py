...
from config import BASE_APP_DIR, format_miles_colombian_int

# --- Rutas y Constantes ---
TEMPLATE_LIQUIDACION_REL_PATH = os.path.join("assets", "templates", "recibo_template_liquidacion.xlsx")
TEMPLATE_LIQUIDACION_PATH = os.path.join(BASE_APP_DIR, TEMPLATE_LIQUIDACION_REL_PATH)

# La carpeta de salida para las liquidaciones
LIQUIDACIONES_OUTPUT_DIR_REL_PATH = "Liquidaciones"
LIQUIDACIONES_OUTPUT_DIR = os.path.join(BASE_APP_DIR, LIQUIDACIONES_OUTPUT_DIR_REL_PATH)
