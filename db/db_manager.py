...
# socios operacones
    ...
    def populate_initial_members(self):
        """
        Carga masiva de los 54 socios iniciales extraídos de las imágenes.
        """
        # Ruta de la foto por defecto (Ajustar si es necesario)
        DEFAULT_PHOTO = r"C:\Users\Jdrua\code\BGC-software\assets\images\default_user.png"
        
        # Lista de socios: (Nombres, Apellidos, Celular, Saldo)
        socios_data = [
        ...
        for nombres, apellidos, celular, saldo in socios_data:
            # Llamamos a tu función add_member existente
            self.add_member(
                nombres=nombres,
                apellidos=apellidos,
                phone=celular,
        ...
        print(f"\n✅ Carga masiva finalizada. {count} socios procesados.")